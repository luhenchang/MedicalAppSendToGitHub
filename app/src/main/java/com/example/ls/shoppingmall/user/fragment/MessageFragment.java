...
public class MessageFragment extends BaseFragment implements MessageFragmentAdapter.OnItemClickListener, View.OnClickListener, MessageActivity.EditMyFragmentItem {
    ...
    private HashMap<String, Object> parames, parame;
    ...
    public void initData() {
        ...
        parames = new HashMap<>();
        parame = new HashMap<>();
        FrameHttpHelper.getInstance().get("https://qy.healthinfochina.com:8080/DOC000010023?usrId=" + userId + "&type=1", parames, new FrameHttpCallback<MessageBean>() {
            @Override
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < adapter.getMyLiveList().size(); i++) {
                    if (adapter.getMyLiveList().get(i).isSelect) {
                        ...
                        parame.put("mesIds[" + i + "]", adapter.getMyLiveList().get(i).getMesId());
                    }
                }
