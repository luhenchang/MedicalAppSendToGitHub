...
public class MedicalMapSelf extends AppCompatActivity implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DISMISS_SPLASH:
                    Animator animator = AnimatorInflater.loadAnimator(MedicalMapSelf.this, R.animator.splash);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_infor_self);
        MyApplication.addActivity(this);
        /*经度app=39.05542纬度=117.238317*/
        //为了解决空指针问题提到最上面的
        Log.e("incurrent", "1");
    ...
    private void parser(String json) {
        ...
        // Toast.makeText(MedicalMapSelf.this, "" + json.toString(), Toast.LENGTH_SHORT).show();
    ...
    class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation bdLocation) {
            ...
            if (isFirstLoc) {
                ...
                //  Toast.makeText(MedicalMapSelf.this, "金纬度：" + changeLatitude + ":纬度" + changeLongitude, Toast.LENGTH_SHORT).show();
