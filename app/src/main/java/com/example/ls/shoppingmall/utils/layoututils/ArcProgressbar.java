...
public class ArcProgressbar extends View {
     ...
     * 圆环半径
     */
    private int mRadius =50; // Diameter英文为直径，该常量表示小圆直径的dp值
    /**
     * 圆环的宽度
     */
    private int mTrokeWidth = 5;
    /**
     * 起始角度
     */
...
/*这个是灰色的圆*/
        ...
        // 设置颜色为红色
        mPaint1.setColor(Color.parseColor("#cbcbcb"));
        /**
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawArc(mRect, 0, 360, false, mPaint1);
        // super.onDraw(canvas);
